...
import (
	...
	cachev1alpha1 "github.com/andyhewitt/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.andyhewitt.me/finalizer"
...
//+kubebuilder:rbac:groups=cache.andyhewitt.me,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.andyhewitt.me,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.andyhewitt.me,resources=memcacheds/finalizers,verbs=update
